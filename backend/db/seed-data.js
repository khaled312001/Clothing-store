// AURA Fashion Store - Curated product catalog
// Every image is a verified Unsplash URL specifically matching the product subject
// Quality: w=900 q=85 for products, w=1200/1400 q=85 for category banners

export const categories = [
  // Top-level
  { slug: 'kids',  name_ar: 'أطفالي', name_en: 'Kids',  icon: 'baby',  parent: null, sort: 1, image: 'https://images.unsplash.com/photo-1522771930-78848d9293e8?w=1400&q=85' },
  { slug: 'women', name_ar: 'حريمي', name_en: 'Women', icon: 'woman', parent: null, sort: 2, image: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1400&q=85' },
  { slug: 'men',   name_ar: 'رجالي', name_en: 'Men',   icon: 'man',   parent: null, sort: 3, image: 'https://images.unsplash.com/photo-1490114538077-0a7f8cb49891?w=1400&q=85' },

  // Kids subcategories
  { slug: 'kids-boys',    name_ar: 'أولاد', name_en: 'Boys',    icon: 'boy',    parent: 'kids', sort: 1, image: 'https://images.unsplash.com/photo-1519278409-1f56fdda7fe5?w=1200&q=85' },
  { slug: 'kids-girls',   name_ar: 'بنات',  name_en: 'Girls',   icon: 'girl',   parent: 'kids', sort: 2, image: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=1200&q=85' },
  { slug: 'kids-newborn', name_ar: 'رضع',   name_en: 'Newborn', icon: 'baby',   parent: 'kids', sort: 3, image: 'https://images.unsplash.com/photo-1522771930-78848d9293e8?w=1200&q=85' },

  // Women subcategories
  { slug: 'women-casual',      name_ar: 'كاجوال',     name_en: 'Casual',      icon: 'shirt', parent: 'women', sort: 1, image: 'https://images.unsplash.com/photo-1485518882345-15568b007407?w=1200&q=85' },
  { slug: 'women-evening',     name_ar: 'سواريه',     name_en: 'Evening',     icon: 'dress', parent: 'women', sort: 2, image: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=1200&q=85' },
  { slug: 'women-sport',       name_ar: 'رياضي',      name_en: 'Sport',       icon: 'sport', parent: 'women', sort: 3, image: 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=1200&q=85' },
  { slug: 'women-accessories', name_ar: 'إكسسوارات', name_en: 'Accessories', icon: 'bag',   parent: 'women', sort: 4, image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=1200&q=85' },

  // Men subcategories
  { slug: 'men-tshirts', name_ar: 'تيشيرتات', name_en: 'T-Shirts', icon: 'tshirt', parent: 'men', sort: 1, image: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=1200&q=85' },
  { slug: 'men-shirts',  name_ar: 'قمصان',    name_en: 'Shirts',   icon: 'shirt',  parent: 'men', sort: 2, image: 'https://images.unsplash.com/photo-1602810316693-3667c854239a?w=1200&q=85' },
  { slug: 'men-pants',   name_ar: 'بنطلونات', name_en: 'Pants',    icon: 'pants',  parent: 'men', sort: 3, image: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=1200&q=85' },
  { slug: 'men-jackets', name_ar: 'جواكت',    name_en: 'Jackets',  icon: 'jacket', parent: 'men', sort: 4, image: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=1200&q=85' },
];
...
export const products = [
  // ============ KIDS - BOYS ============
  {
    category_slug: 'kids-boys', sku: 'AURA-KB-001', brand: 'AURA Kids',
  ...
  {
    category_slug: 'kids-boys', sku: 'AURA-KB-002', brand: 'AURA Kids',
    ...
    images: [
      'https://images.unsplash.com/photo-1600185365926-3a2ce3cdb9eb?w=900' + Q,
      'https://images.unsplash.com/photo-1542272604-787c3835535d?w=900' + Q,
    ],
    variants: variants(['4Y','6Y','8Y','10Y','12Y'], [C.blue, C.navy, C.black]),
  },
  {
    category_slug: 'kids-boys', sku: 'AURA-KB-003', brand: 'AURA Sport',
  ...
  // ============ KIDS - GIRLS ============
  {
    category_slug: 'kids-girls', sku: 'AURA-KG-001', brand: 'AURA Kids',
  ...
  {
    category_slug: 'kids-girls', sku: 'AURA-KG-002', brand: 'AURA Kids',
  ...
  {
    category_slug: 'kids-girls', sku: 'AURA-KG-003', brand: 'AURA Kids',
    ...
    images: [
      'https://images.unsplash.com/photo-1615655406736-b37c4fabf923?w=900' + Q,
      'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=900' + Q,
    ],
  ...
  // ============ KIDS - NEWBORN ============
  {
    category_slug: 'kids-newborn', sku: 'AURA-KN-001', brand: 'AURA Baby',
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1544717304-a2db4a7b16ee?w=900' + Q,
    ],
    variants: variants(['0-3M','3-6M','6-9M','9-12M'], [C.white, C.pink, C.blue, C.yellow]),
  },
  {
    category_slug: 'kids-newborn', sku: 'AURA-KN-002', brand: 'AURA Baby',
  ...
  // ============ WOMEN - CASUAL ============
  {
    category_slug: 'women-casual', sku: 'AURA-WC-001', brand: 'AURA',
  ...
  {
    category_slug: 'women-casual', sku: 'AURA-WC-002', brand: 'AURA',
  ...
  {
    category_slug: 'women-casual', sku: 'AURA-WC-003', brand: 'Denim Co',
    ...
    images: [
      'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=900' + Q,
      'https://images.unsplash.com/photo-1542272604-787c3835535d?w=900' + Q,
    ],
    variants: variants(['S','M','L','XL'], [C.blue, C.navy, C.black]),
  },
  {
    category_slug: 'women-casual', sku: 'AURA-WC-004', brand: 'AURA',
    ...
    images: [
      'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=900' + Q,
    ],
  ...
  // ============ WOMEN - EVENING ============
  {
    category_slug: 'women-evening', sku: 'AURA-WE-001', brand: 'AURA Couture',
    ...
    images: [
      'https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=900' + Q,
  ...
  // ============ WOMEN - SPORT ============
  {
    category_slug: 'women-sport', sku: 'AURA-WS-001', brand: 'AURA Sport',
    ...
    images: [
      'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=900' + Q,
      'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=900' + Q,
    ],
    variants: variants(['S','M','L','XL'], [C.black, C.navy, C.gray]),
  },
  {
    category_slug: 'women-sport', sku: 'AURA-WS-002', brand: 'AURA Sport',
    ...
    images: [
      'https://images.unsplash.com/photo-1558537348-c0f8e733989d?w=900' + Q,
      'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=900' + Q,
    ],
  ...
  // ============ WOMEN - ACCESSORIES ============
  {
    category_slug: 'women-accessories', sku: 'AURA-WA-001', brand: 'AURA Accessories',
  ...
  {
    category_slug: 'women-accessories', sku: 'AURA-WA-002', brand: 'AURA Accessories',
    ...
    images: [
      'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=900' + Q,
    ],
    variants: [
  ...
  // ============ MEN - T-SHIRTS ============
  {
    category_slug: 'men-tshirts', sku: 'AURA-MT-001', brand: 'AURA Men',
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1586790170083-2f9ceadc732d?w=900' + Q,
      'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=900' + Q,
    ],
    variants: variants(['S','M','L','XL','XXL'], [C.navy, C.white, C.black, C.green]),
  },
  {
    category_slug: 'men-tshirts', sku: 'AURA-MT-003', brand: 'AURA Men',
  ...
  // ============ MEN - SHIRTS ============
  {
    category_slug: 'men-shirts', sku: 'AURA-MS-001', brand: 'AURA Formal',
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1620012253295-c15cc3e65df4?w=900' + Q,
    ],
    variants: variants(['S','M','L','XL','XXL'], [C.white, C.blue, C.black, C.beige]),
  },
  {
    category_slug: 'men-shirts', sku: 'AURA-MS-002', brand: 'AURA Casual',
  ...
  // ============ MEN - PANTS ============
  {
    category_slug: 'men-pants', sku: 'AURA-MP-001', brand: 'Denim Co',
    ...
    images: [
      'https://images.unsplash.com/photo-1542272604-787c3835535d?w=900' + Q,
      'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=900' + Q,
    ],
    variants: variants(['30','32','34','36','38'], [C.blue, C.navy, C.black]),
  },
  {
    category_slug: 'men-pants', sku: 'AURA-MP-002', brand: 'AURA Men',
  ...
  {
    category_slug: 'men-pants', sku: 'AURA-MP-003', brand: 'AURA Sport',
    ...
    images: [
      'https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=900' + Q,
    ],
  ...
  // ============ MEN - JACKETS ============
  {
    category_slug: 'men-jackets', sku: 'AURA-MJ-001', brand: 'AURA Outerwear',
  ...
  {
    category_slug: 'men-jackets', sku: 'AURA-MJ-003', brand: 'AURA Outerwear',
    ...
    images: [
      'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=900' + Q,
      'https://images.unsplash.com/photo-1542272604-787c3835535d?w=900' + Q,
    ],
...
export const reviews = [
  { product_sku: 'AURA-MT-001', rating: 5, title: 'خامة ممتازة', comment: 'القطن المصري حقاً متميز، يستحق السعر تماماً!' },
  { product_sku: 'AURA-MT-001', rating: 5, title: 'Perfect fit',    comment: 'Great quality cotton, very comfortable.' },
  { product_sku: 'AURA-MT-001', rating: 4, title: 'جيد جداً',        comment: 'تيشيرت ممتاز لكن المقاس جاء أكبر قليلاً.' },
  { product_sku: 'AURA-WC-001', rating: 5, title: 'أنيقة ومريحة',     comment: 'البلوزة جميلة جداً وخامتها فاخرة.' },
  { product_sku: 'AURA-WC-001', rating: 5, title: 'Loved it',        comment: 'Beautiful fabric and perfect fit.' },
  { product_sku: 'AURA-WE-001', rating: 5, title: 'فستان حلم',       comment: 'لبسته في حفلة وكل اللي شافه قال عنه!' },
  { product_sku: 'AURA-MJ-001', rating: 5, title: 'جلد فاخر',         comment: 'الجاكيت رائع والجلد أصلي وممتاز.' },
  { product_sku: 'AURA-KG-001', rating: 5, title: 'بنتي حبته',        comment: 'الفستان جميل والخامة ناعمة على بشرتها.' },
  { product_sku: 'AURA-MP-001', rating: 4, title: 'جينز ممتاز',       comment: 'القصة مظبوطة والخامة مرنة ومريحة.' },
  { product_sku: 'AURA-WC-003', rating: 5, title: 'أحلى جينز',        comment: 'يبرز القوام بشكل جميل، اشتريت قطعتين.' },
];
