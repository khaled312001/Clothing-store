export const dictionaries = {
  ar: {
    site: { name: 'أُورا للأزياء', shortName: 'AURA', tagline: 'متجرك للأزياء العصرية' },
    nav: {
    ...
    hero: {
      ...
      title3: 'بـ',
      title4: 'AURA',
      subtitle: 'اكتشف عالم الأزياء الفاخرة لكل أفراد العائلة — تشكيلة مختارة بعناية من أفخم الخامات وأحدث صيحات الموضة العالمية.',
      cta: 'تسوّق المجموعة',
      cta2: 'استكشف العروض',
      stat1Label: 'منتج', stat1Num: '500+',
      stat2Label: 'عميل سعيد', stat2Num: '12K+',
      stat3Label: 'تقييم 5 نجوم', stat3Num: '4.9',
    },
    sections: {
    ...
    checkout: {
      ...
      thankYou: 'شكراً لشرائك من AURA', viewOrder: 'عرض تفاصيل الطلب',
    },
    auth: {
  ...
  en: {
    site: { name: 'AURA Fashion', shortName: 'AURA', tagline: 'Your modern fashion destination' },
    nav: {
    ...
    hero: {
      ...
      title3: 'with',
      title4: 'AURA',
      subtitle: "Discover a curated world of premium fashion for the whole family — finest fabrics and the latest trends from around the globe.",
      cta: 'Shop the collection',
      cta2: 'Explore deals',
      stat1Label: 'Products',  stat1Num: '500+',
      stat2Label: 'Happy customers', stat2Num: '12K+',
      stat3Label: '5-star reviews', stat3Num: '4.9',
    },
    sections: {
    ...
    checkout: {
      ...
      thankYou: 'Thank you for shopping with AURA', viewOrder: 'View order details',
    },
    auth: {
